...
<nav className=" mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 py-5 bg-gray-50 rounded border-gray-200 dark:bg-gray-800 dark:border-gray-700">
  <div className="container flex flex-wrap justify-between items-center mx-auto">
    ...
    <a href="#" className="flex items-center">
        <img src="https://randomuser.me/api/portraits/women/2.jpg" className="mr-3 h-6 rounded-full sm:h-10" alt="Flowbite Logo"/>
        <span className="self-center text-lg ">House Vaughn</span>
    </a>
  </div>
</nav>
